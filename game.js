class Main extends Phaser.Scene {
    ...
    create() {
        ...
        this.score = 0;
        this.labelScore = this.add.text(20, 20, "0", { fontSize: 40, color: "yellow" });
        this.author = this.add.text(20, 20, "Created by Bashynska Viktoria", { fontSize: 14, color: "black" });
        ...
        //Обробимо зіткнення літака та труби. 
    ...
    update() {
        ...
        //зробимо перевірку “якщо натиснули на пробіл”:
